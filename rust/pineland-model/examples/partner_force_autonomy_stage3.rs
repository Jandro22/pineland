...
fn write_row(
    ...
    let row = vec![
        ...
        f9(assay.operational_readiness_retention),
        f9(assay.composite_capability),
        f9(assay.composite_capability_v1),
