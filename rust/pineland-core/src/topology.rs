...
const DISTRICTS: [(&str, &str, f64, f64, &str, f64, f64, f64); 17] = [
    (
        "D01",
        "Stonebridge Federal",
        1_450_000.0,
...
impl StaticTopology {
    ...
    pub fn synthetic(locality_count: usize, microzones_per_locality: usize) -> Self {
        ...
        Self {
            ...
            zone_population_share: vec![1.0 / zones_per_locality as f64;
    ...
    pub fn pineland(
        ...
        let mut primary_zone = primary_zone;
        ...
        let topology = StaticTopology {
            ...
            district_language_patterns: DISTRICTS
                .iter()
