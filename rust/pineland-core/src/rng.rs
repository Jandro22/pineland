...
const DEFAULT_STREAMS: &[&str] = &[
    ...
    "event-scheduling",
    "process:patrol",
    "process:contact_scan",
    "process:contact",
    "process:organized_action",
    "process:command",
    "process:force_movement",
    "process:logistics",
    "process:information",
    "process:beliefs",
    "process:physical_refresh",
    "process:social_influence",
    "process:mobility",
    "process:recruitment",
    "process:organization_ecology",
    "process:governance",
    "process:economy",
    "process:political_order",
    "process:foreign_affairs",
    "process:peace_process",
    "process:recording_noise",
    "process:checkpoint",
    "recording:patrol",
    "recording:contact_scan",
    "recording:contact",
    "recording:organized_action",
    "recording:command",
    "recording:force_movement",
    "recording:logistics",
    "recording:information",
    "recording:beliefs",
    "recording:physical_refresh",
    "recording:social_influence",
    "recording:mobility",
    "recording:recruitment",
    "recording:organization_ecology",
    "recording:governance",
    "recording:economy",
    "recording:political_order",
    "recording:foreign_affairs",
    "recording:peace_process",
    "recording:recording_noise",
