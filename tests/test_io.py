...
class IOTests(unittest.TestCase):
    def test_configuration_round_trip_and_result_files(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertTrue((root / "result" / "political_diagnostics.json").exists())
            self.assertTrue((root / "result" / "political_transfers.jsonl").exists())
            ...
            self.assertTrue((root / "result" / "recorded_empirical_observations.jsonl").exists())
            self.assertTrue((root / "result" / "recorded_vs_true_metrics.json").exists())
