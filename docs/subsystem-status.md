...
| Foreign affairs and external support | Implemented; integrated Partner-Force Stage 4 completed | `docs/foreign-affairs.md`, withdrawal/support mechanisms, Stage-4 contracts, compact Stage-4 evidence | Stage-4 findings are synthetic causal results, not empirical policy-effect estimates |
