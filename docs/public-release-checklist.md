...
- [ ] README quick-start commands are tested literally.
      The earlier missing-`assays` clean-clone blocker is resolved in the
      integrated Stage-4 tree; rerun the literal quick starts from the final
      release candidate before checking this item.
...
[`docs/public-release-readiness-2026-09-20.md`](public-release-readiness-2026-09-20.md).
